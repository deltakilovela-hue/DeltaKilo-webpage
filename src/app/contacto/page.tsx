...
export default function ContactoPage() {
  return (
    <>
      ...
      {/* ── 3. DATA GRID HERO + CONTACT SECTION ──── */}
      <DataGridHero
        rows={20}
        cols={32}
        spacing={3}
      ...
      >
        ...
        {/* Contact Form + Info */}
        <section className="section-padding border-t border-white/5 mt-16">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
              ...
              <div>
                ...
                <div className="space-y-5 mb-10">
                  <a
                    ...
                    className="flex items-start gap-4 p-5 rounded-xl border border-[#1e1e1e] bg-[#0f0f0f]/80 hover:border-[#0dcfcf]/20 transition-all group"
                  >
                ...
                {/* What to expect */}
                <div className="p-5 rounded-xl border border-[#1e1e1e] bg-[#0f0f0f]/80">
