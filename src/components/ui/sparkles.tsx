          ...
          options={{
            ...
            interactivity: {
              events: {
                ...
                resize: true as unknown as object,
              },
              modes: {
                push: { quantity: 4 },
            ...
            particles: {
              ...
              opacity: {
                value: { min: 0.1, max: 1 },
                animation: {
                  count: 0, enable: true, speed: speed || 4,
                  decay: 0, delay: 0, sync: false,
                  mode: "auto", startValue: "random", destroy: "none",
                },
              },
