      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <a href="https://deltakilo.com.mx/" className="flex items-center gap-3 group w-fit">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a href="https://www.facebook.com/Deltakilosoluciones/" target="_blank" rel="noopener noreferrer"
                aria-label="Facebook"
              ...
              <a href="https://www.instagram.com/deltakilosoluciones" target="_blank" rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-8 h-8 rounded-lg border border-white/[0.08] bg-white/[0.04] flex items-center justify-center text-white/40 hover:text-[#E1306C] hover:border-[#E1306C]/30 transition-all duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/5215663864984" target="_blank" rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-8 h-8 rounded-lg border border-white/[0.08] bg-white/[0.04] flex items-center justify-center text-white/40 hover:text-[#25d366] hover:border-[#25d366]/30 transition-all duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="https://wa.me/5215663864984"
                target="_blank"
