...
export function FunnelsPage() {
  ...
  return (
    <>
      ...
      <section
        ref={heroRef}
        className="h-[300vh] bg-[#080808] w-full relative overflow-clip"
      >
        {/* Texto + CTA — sticky en la parte superior, sin tocarse con el SVG */}
        <div className="sticky top-0 z-20 flex flex-col items-center text-center px-6 pt-28 pb-10 pointer-events-none">
          <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal pb-4
                        bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300
                        max-w-5xl mx-auto leading-tight">
            Cada prospecto se convierte en una oportunidad real.
          </p>
          <p className="text-sm sm:text-base md:text-xl text-neutral-400 max-w-lg mx-auto mt-4 mb-8">
            Funnels automáticos · CRM · Seguimiento inteligente.
            Tu negocio nunca pierde otro lead.
          </p>
          <div className="flex flex-col sm:flex-row items-center gap-3 pointer-events-auto">
            <a
              href="https://wa.me/5215663864984?text=Hola,%20quiero%20un%20funnel%20automatizado%20💊"
              target="_blank"
              ...
              className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 text-sm font-semibold
                         ...
                         shadow-lg hover:shadow-[#D4AF37]/30 hover:shadow-xl group"
            >
        ...
        {/* Líneas SVG animadas — sin título ni descripción, solo el efecto */}
        <GoogleGeminiEffect
          pathLengths={[
            pathLengthFirst,
            pathLengthSecond,
