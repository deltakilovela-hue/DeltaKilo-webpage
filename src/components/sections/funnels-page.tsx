    ...
    <>
      ...
      >
        <GoogleGeminiEffect
          ...
          title="Cada prospecto se convierte en una oportunidad real."
          description="Funnels automáticos · CRM · Seguimiento inteligente. Tu negocio nunca pierde otro lead."
          className="pt-40"
          cta={
            <div className="flex flex-col items-center gap-3 z-30 md:mt-52 mt-16">
              <a
